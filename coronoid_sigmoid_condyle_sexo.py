# -*- coding: utf-8 -*-
"""Coronoid/Sigmoid/Condyle - Sexo.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1gox5RxdmzXdvuPOSenPR70R6o1eEQE1e
...
colunas = [ 'sex', 'Right condyle', 'Left condyle', 'Right coronoid',
       'Left coronoid', 'Right sigmoid', 'Left sigmoid', 'Co-GN ']
...
colors = plt.cm.YlOrBr(np.linspace(0.2, 1, len(feature_importance_sorted)))
...
colors = plt.cm.YlOrBr(np.linspace(0.2, 1, len(feature_importance_lr)))
plt.figure(figsize=(10, 6))
...
# Treinar e prever com o melhor modelo no conjunto de características reduzido
...
plt.figure(figsize=(10, 6))
colors = plt.cm.YlOrBr(np.linspace(0.2, 1, len(df_imp_features_dt2_sorted)))
...
plt.figure(figsize=(10, 6))
colors = plt.cm.YlOrBr(np.linspace(0.2, 1, len(df_imp_features_dt3_sorted)))
